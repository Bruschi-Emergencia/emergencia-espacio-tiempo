...
════════════════════════════════════════════════════════════════
EXTENSIÓN MESOSCÓPICA (SIM 8):
  SIM 8 extiende este resultado al régimen mesoscópico (δ = 2×r_c)
  y demuestra analíticamente que el kernel 1/d_ij de DEE converge
  a Ric con coeficiente C_{1/d} = (5/6) × C_uniforme.
  Ver §6.7 del documento y sim8_kappa_mesocopico.py.
════════════════════════════════════════════════════════════════
"""
import numpy as np
import matplotlib
